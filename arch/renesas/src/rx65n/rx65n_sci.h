...
#define _00_SCI_ASYNCHRONOUS_OR_I2C_MODE          (0x00U)   /* Asynchronous or simple I2C mode */
#define _80_SCI_CLOCK_SYNCHRONOUS_OR_SPI_MODE     (0x80U)   /* Clock synchronous or simple SPI mode */
