...
Macro definitions
***********************************************************************************************************************/
#define _EF_TMR0_COMP_MATCH_VALUE_A                 (0xEFU) /* TCORA value */
#define _BF_TMR0_COMP_MATCH_VALUE_B                 (0xBFU) /* TCORB value */
#define _BF_TMR1_COMP_MATCH_VALUE_A                 (0xBFU) /* TCORA value */
#define _BF_TMR1_COMP_MATCH_VALUE_B                 (0xBFU) /* TCORB value */
#define _EF_TMR2_COMP_MATCH_VALUE_A                 (0xEFU) /* TCORA value */
#define _BF_TMR2_COMP_MATCH_VALUE_B                 (0xBFU) /* TCORB value */
#define _EF_TMR3_COMP_MATCH_VALUE_A                 (0xEFU) /* TCORA value */
#define _BF_TMR3_COMP_MATCH_VALUE_B                 (0xBFU) /* TCORB value */
